...
const DeleteFood = ({deleteFn, id}) => {    
  ...
  const deleteCloseBtn = () =>{
    ...
    return (
    <React.Fragment>
        <button className='absolute bottom-[-10px] z-20 bg-red-500 text-white p-1 md:p-2 rounded-full right-2 md:right-4' onClick={handleClickOpen}><MdDelete size={20}/></button> 
      <Dialog
        open={open}
        keepMounted
        onClose={handleClose}
