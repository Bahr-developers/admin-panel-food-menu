...
const DeleteFood = ({deleteFn, id}) => {    
  ...
  const deleteCloseBtn = () =>{
    ...
    return (
    <React.Fragment>
        <button className='absolute block top-[130px] md:top-[275px] z-10 bg-red-500 text-white p-1 md:p-2 rounded-full right-2 md:right-4' onClick={handleClickOpen}><MdDelete size={20}/></button> 
      <Dialog
        open={open}
        keepMounted
        onClose={handleClose}
