...
const Loading = () => {
    return (
        <div className=" min-h-screen text-[#45d6b5] flex flex-col justify-center items-center">
            <svg className="w-[150px]" version="1.1"
                ...
                <circle cx="40" cy="40" r="30" fill="none" strokeWidth="2" stroke="currentColor" />
            ...
            <h3 className="text-black text-[29px] font-bold">Loading...</h3>
        </div>
    );
};
